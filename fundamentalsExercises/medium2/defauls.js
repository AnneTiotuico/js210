...
/*
The limitation is that both rely on the truthiness of the passed in value.
So if we pass in a 0 for any of the other arguments, exclusing discount, it will evaluate to false
and assign the default value, which may cause unwanted results.
